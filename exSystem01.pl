...
main :- write('_______________________________________________________________________________'), nl,
        ...
        write(' undo. para resetar suas respostas. ')                                            , nl, nl,
        write('Para responder, utilize as palavras yes/no OU y/n. '), nl, 
        write('_______________________________________________________________________________')     , nl,   
        write(' '),
        read(Command),
        command(Command).
